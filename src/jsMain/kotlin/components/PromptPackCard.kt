...
@Composable
fun PromptPackCard(promptPack: PromptPack, onClick: () -> Unit) {
    Div({
        style {
            padding(1.cssRem)
        ...
        Div({
            ...
            Text("${promptPack.prompts.size} ${if (promptPack.prompts.size == 1) "prompt" else "prompts"} for ${promptPack.level}")
        }
    }
}
